#!/bin/bash
#$ -N example1
#sbatch --partition=gpu --gres=gpu:1 --time=15:00:00 name.sh
...
#python train.py --dataroot ./datasets/doodle --name doodle_cyclegan --model cycle_gan --display_id 0
#CUDA_VISIBLE_DEVICES=0,1 python train.py --dataset=horse2zebra
CUDA_VISIBLE_DEVICES=0,1 python train.py --dataset=doodle
